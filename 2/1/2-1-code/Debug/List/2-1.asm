...
; 0000 0024           if(i < 10){
	...
	CPC  R7,R31
	BRLT _0xB
; 0000 0025            PORTD =  Numbers[i];
; 0000 0026          }else{
; 0000 0027            i = 0 ;
	CLR  R6
	CLR  R7
; 0000 0028            PORTD = Numbers[i];
_0xB:
	MOVW R30,R6
...
; 0000 0043 // Clock value: 125.000 kHz
...
; 0000 004A // Timer1 Overflow Interrupt: On

...
; 0000 0025       ++ TimerOverFlowCounter;
	...
	MOVW R4,R30
; 0000 0026 
; 0000 0027       if(TimerOverFlowCounter ==1000){
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0x4
; 0000 0028           lcd_putchar('');
	LDI  R26,LOW(0)
	RCALL _lcd_putchar
; 0000 0029           lcd_putchar(alph[i]);
	LDI  R26,LOW(_alph)
	LDI  R27,HIGH(_alph)
	ADD  R26,R10
	ADC  R27,R11
...
; 0000 0030              }
; 0000 0031 
; 0000 0032             lcd_gotoxy(x,y);
_0x5:
	ST   -Y,R6
	MOV  R26,R8
	RCALL _lcd_gotoxy
; 0000 0033             TimerOverFlowCounter=0;
	CLR  R4
	CLR  R5
; 0000 0034 
; 0000 0035             if(i == 26){

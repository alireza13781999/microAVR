...
; 0000 0032 }
; 0000 0033 
; 0000 0034 if(turn_right==true) {
_0x9:
	LDI  R30,LOW(1)
	CP   R30,R7
	BRNE _0xA
; 0000 0035     if(T>=0 && T<=3) {
	CLR  R0
	CP   R4,R0
	CPC  R5,R0
	BRLT _0xC
...
; 0000 0057 // Clock value: 11.719 kHz
; 0000 0058 // Mode: Normal top=0xFF
; 0000 0059 // OC0 output: Disconnected
; 0000 005A // Timer Period: 20.821 ms
; 0000 005B TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
; 0000 005C TCNT0=0x0C;
	LDI  R30,LOW(12)
	OUT  0x32,R30
; 0000 005D OCR0=0x00;
	LDI  R30,LOW(0)
...
; 0000 0081 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0082 
...
; 0000 00B4       if(PINC.2==0) {
	SBIC 0x13,2
	RJMP _0x17
; 0000 00B5              if(turn_right==true) {
	LDI  R30,LOW(1)
	CP   R30,R7
	BRNE _0x18
; 0000 00B6                 turn_right=false;
	CLR  R7
; 0000 00B7                 if(T>=0 && T<=3) {
	CLR  R0
	CP   R4,R0
	CPC  R5,R0
	BRLT _0x1A
...
; 0000 00BC             } else {
	RJMP _0x1D
_0x18:
; 0000 00BD                 turn_right=true;
	LDI  R30,LOW(1)
	MOV  R7,R30
; 0000 00BE                 if(T>=0 && T<=3) {
	CLR  R0
	CP   R4,R0
	CPC  R5,R0
	BRLT _0x1F

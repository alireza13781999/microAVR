...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _counter1=R4
	.DEF _counter1_msb=R5
	.DEF _counter2=R6
	.DEF _counter2_msb=R7
	.DEF _button_pressed=R9
	.DEF _turn_right=R8
	.DEF _T=R10
	.DEF _T_msb=R11
...
; 0000 002D if(button_pressed==true) {
	LDI  R30,LOW(1)
	CP   R30,R9
	BREQ PC+2
	RJMP _0x4
; 0000 002E     if(counter2>=counter1) {
	__CPWRR 6,7,4,5
	BRGE PC+2
	RJMP _0x5
; 0000 002F         if(T==0) {
...
; 0000 003C         }
_0xE:
; 0000 003D         if(turn_right==false) {
	TST  R8
	BRNE _0xF
; 0000 003E             if(counter1>counter_limit[0]) {
	LDS  R30,_counter_limit
	LDS  R31,_counter_limit+1
	CP   R30,R4
	CPC  R31,R5
	BRGE _0x10
; 0000 003F                 counter1--;
...
; 0000 0043         } else {
	RJMP _0x12
_0xF:
; 0000 0044             if(counter1<counter_limit[1]) {
	__GETW1MN _counter_limit,2
	CP   R4,R30
	CPC  R5,R31
	BRGE _0x13
; 0000 0045                 counter1++;
...
; 0000 0046             } else {
	RJMP _0x14
_0x13:
; 0000 0047                 turn_right=false;
	CLR  R8
; 0000 0048                 button_pressed=false;
	CLR  R9
; 0000 0049             }
_0x14:
; 0000 004A         }
_0x12:
; 0000 004B         counter2 = 0;
	CLR  R6
	CLR  R7
; 0000 004C     }
; 0000 004D     counter2++;
...
; 0000 0065 // Clock value: 187.500 kHz
; 0000 0066 // Mode: Normal top=0xFF
; 0000 0067 // OC0 output: Disconnected
; 0000 0068 // Timer Period: 1.3013 ms
; 0000 0069 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(3)
	OUT  0x33,R30
; 0000 006A TCNT0=0x0C;
	LDI  R30,LOW(12)
	OUT  0x32,R30
; 0000 006B OCR0=0x00;
	LDI  R30,LOW(0)
...
; 0000 008F TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0090 
...
; 0000 00B4 
; 0000 00B5 
; 0000 00B6 turn_right=false;
	CLR  R8
; 0000 00B7 counter1 = counter_limit[1];
	RCALL SUBOPT_0x0
; 0000 00B8 counter2 = 0;
; 0000 00B9 T = 0;
	CLR  R10
	CLR  R11
; 0000 00BA button_pressed=true;
	LDI  R30,LOW(1)
	MOV  R9,R30
; 0000 00BB DDRC = 0x00;
	LDI  R30,LOW(0)
...
; 0000 00C6       if(PINC.2==0 &&  button_pressed==false) {
	SBIC 0x13,2
	RJMP _0x19
	TST  R9
	BREQ _0x1A
_0x19:
	RJMP _0x18
_0x1A:
; 0000 00C7              counter1 = counter_limit[1];
	RCALL SUBOPT_0x0
; 0000 00C8              counter2 = 0;
; 0000 00C9              turn_right=false;
	CLR  R8
; 0000 00CA              button_pressed=true;
	LDI  R30,LOW(1)
	MOV  R9,R30
; 0000 00CB         }
; 0000 00CC       }
...
SUBOPT_0x0:
	__GETWRMN 4,5,_counter_limit,2
	CLR  R6
	CLR  R7
	RET
